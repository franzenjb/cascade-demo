...
// 171 vertices, simplified from 11,434-vertex NIFC perimeter via Douglas-Peucker.
// Covers ~20km span west of Redding, jagged boundary on all sides.
// Bbox approx: [-122.66, 40.555] to [-122.44, 40.755].
